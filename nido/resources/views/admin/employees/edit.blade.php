  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{ trans('dashboard.edit_employee')}}</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">{{ trans('dashboard.home')}}</a></li>
              <li class="breadcrumb-item active">{{ trans('dashboard.edit_employee')}}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
         <!-- Input addon -->
        <form action="{{ route('employees.update',[app()->getLocale(), $employee->id_employee]) }}" method="POST" enctype="multipart/form-data">
         @csrf  
         @method('PUT')
         ...
         <div class="card card-info">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="first_name" placeholder="Enter  name" value="{{ $employee->first_name }}" autofocus>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="last_name" placeholder="Enter  name" value="{{ $employee->last_name }}" autofocus>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="phone"
                         data-inputmask="'mask': ['999-999-9999 [x99999]', '+099 99 99 9999[9]-9999']" value="{{ $employee->phone }}" data-mask>
                   @if ($errors->has('phone'))
                         <div class="alert alert-danger alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                ...
                <div class="form-group">
                  ...
                  <select name="company_id" class="form-control select2" style="width: 100%;">
                    @foreach ($companies as $id_company => $company_name)
                      <option value="{{ $employee->company_id == $id_company ? $employee->company_id : $id_company}}" selected="selected">{{$company_name}}</option>
                    @endforeach
                  </select>
                </div>
